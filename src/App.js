...
//const ipfsapi = 'https://ipfs.swarm.city'
    ...
    return (
      <Router>
        ...
        <div className="App">
          ...
          <div className="item">
            <div className="description dont-break-out">{this.state.description}</div>
            <div className="timestamp">{this.state.timestamp}</div>
            <div className="itembottom">
              <div className="user">
                <UserAvatar className="avatar" size="48" name={this.state.hashtagMaintainer} src={this.state.hashtagAvatarData} />
                <div className="username">{this.state.hashtagMaintainer} - {this.state.seekerRep}</div>
              </div>
              <div className="amount">
                <div className="currency">SWT</div>
                <div className="value">{this.state.itemValue}</div> 
              </div>
            </div>
          </div>
